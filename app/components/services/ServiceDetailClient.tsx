    ...
    <main style={{ background: '#000', color: '#fff' }}>
      ...
      >
        ...
        >
          ...
          <motion.div style={{ y: heroTextY, opacity: heroOpacity, position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: '1.1rem', letterSpacing: '0.14em', color: 'rgba(255,255,255,0.22)', textTransform: 'uppercase', fontWeight: 500 }}>
                {String(service.num).padStart(2, '0')} / 09
              </span>
            </div>

            {/* Title */}
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '4rem 0 2.4rem' }}>
              <SplitText
                as="h1"
                mode="lines"
                text={service.title}
                style={{
                  fontSize: 'clamp(3.6rem, 4.6vw, 6.8rem)',
            ...
            <motion.p
              ...
              transition={{ duration: 1, ease: [0.7, 0, 0.3, 1], delay: 0.55 }}
              style={{
                fontSize: 'clamp(1.4rem, 1.3vw, 1.7rem)',
                lineHeight: 1.6, color: 'rgba(255,255,255,0.4)',
                margin: 0, fontStyle: 'italic', maxWidth: 360,
              }}
            >
              {service.tagline}
            </motion.p>
        ...
        <motion.div
          ...
          style={{ position: 'absolute', bottom: '4rem', right: '4rem', zIndex: 4, display: 'flex', alignItems: 'center', gap: '1rem' }}
        >
          <span style={{ fontSize: '1.1rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.28)' }}>Scroll</span>
          <span style={{ display: 'block', width: 40, height: '1px', background: 'rgba(255,255,255,0.2)' }} />
        </motion.div>
      </section>
      ...
      <section className="svc-idea" style={{ padding: '12rem 5.6rem' }}>
        <div style={{ maxWidth: 1300, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: '8rem', alignItems: 'start' }} className="svc-idea-grid">
            {/* Left label */}
            ...
            <div>
              <SplitText
                ...
                style={{
                  ...
                  marginBottom: service.description.length > 1 ? '5.6rem' : 0,
                }}
              />

              {service.description[1] && (
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4.8rem', paddingTop: '5.6rem', borderTop: '1px solid rgba(255,255,255,0.07)' }} className="svc-idea-sub">
      ...
      {service.highlights.length > 0 && (
        ...
        >
          <div style={{ maxWidth: 1300, margin: '0 auto' }}>
            ...
            {/* Header row */}
            <div className="svc-delivers-head" style={{
              display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end',
              gap: '4rem', padding: '7rem 0 5rem',
              borderBottom: '1px solid rgba(255,255,255,0.07)',
            }}>
              <div>
                <motion.span {...fadeUp()} style={{ display: 'block', fontSize: '1.1rem', letterSpacing: '0.16em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.28)', marginBottom: '1.6rem' }}>
                  What You Receive
                </motion.span>
                <SplitText
                  as="h2"
              ...
              <motion.p {...fadeUp(0.1)} className="svc-delivers-sub" style={{
                fontSize: 'clamp(1.4rem, 1.4vw, 1.7rem)', lineHeight: 1.7,
                color: 'rgba(255,255,255,0.3)', maxWidth: 360,
                alignSelf: 'flex-end', margin: 0, textAlign: 'right',
              }}>
            ...
            {/* Items */}
            <div className="svc-delivers-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
              {service.highlights.map((item, i) => (
                <motion.div
                  key={i}
                  {...fadeUp(Math.floor(i / 2) * 0.08)}
                  className="svc-deliver-cell"
                  style={{
                    padding: '4.4rem 0',
                    borderBottom: '1px solid rgba(255,255,255,0.07)',
                    borderRight: i % 2 === 0 ? '1px solid rgba(255,255,255,0.07)' : 'none',
                    paddingRight: i % 2 === 0 ? '7rem' : '0',
                    paddingLeft: i % 2 === 1 ? '7rem' : '0',
                    display: 'flex', gap: '2.4rem', alignItems: 'flex-start',
                  }}
                >
                  <span style={{
                    fontSize: 'clamp(3.6rem, 4vw, 5.6rem)',
                    fontWeight: 700, lineHeight: 1,
                    color: 'rgba(255,255,255,0.05)',
                    letterSpacing: '-0.04em',
                    flexShrink: 0, minWidth: '4.5rem',
                  }}>
                    {String(i + 1).padStart(2, '0')}
                  </span>
                  <p style={{
                    ...
                    paddingTop: '0.3rem', fontWeight: 400,
                  }}>
                    {item}
                  </p>
                </motion.div>
      ...
      <style>{`
        ...
        @media (max-width: 960px) {
          ...
          .svc-idea-sub { grid-template-columns: 1fr !important; gap: 3rem !important; }
        }
        /* Deliverables */
        @media (max-width: 960px) {
          .svc-delivers { padding: 0 2.4rem 8rem !important; }
          .svc-delivers-head { flex-direction: column !important; align-items: flex-start !important; }
          .svc-delivers-sub { text-align: left !important; }
          .svc-delivers-grid { grid-template-columns: 1fr !important; }
          .svc-deliver-cell { border-right: none !important; padding-right: 0 !important; padding-left: 0 !important; }
        }
        /* Gallery */
        @media (max-width: 768px) {
